...
Table 1. provides the total number of discharges for all the activities and its percentage variation through the period of analysis. As shown here, the total number of hospital discharges is decreased from 2016 to 2019. In particular, from 2018 to 2019 the number has dropped from 8.356.874 to 8.522.456, with a decreased of 1.733%.
 ...
 geom_histogram(stat = "identity") + 
  coord_flip() + 
   theme(axis.text.x  = element_text(angle = 90, 
                                    hjust = 1, 
                                    vjust = 0.5)) +  
  labs(title = "DEGENZA E MEDIA PER OGNI MDC",
              subtitle = "Acuti - Regime ordinario",
       x = "CLASSE MDC",
       y = "GIORNI DI DEGENZA") 
